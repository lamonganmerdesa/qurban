		...
		<div class="box">
			<div class="box-header with-border">
				...
				<div class="block-options pull-right">
                    <a class="btn btn-danger btn-sm" href="?p=tambah_panitia"><i class="fa fa-plus"></i> Tambah</a>
                </div>
            ...
            <table id="myTable1" class="responsive display nowrap table table-bordered table-striped" cellspacing="0" width="100%">
                ...
                <?php
					$i=1;
					$tp=mysqli_query($koneksi, "SELECT * FROM panitia ORDER BY id");
                ...
                <tr>
                    ...
                    <?php
						echo "
							<a class='btn btn-primary btn-sm' href='?p=panitia_edit&id=$r[id]'><i class='fa fa-edit'></i>&nbsp;&nbsp;&nbsp;Edit</a>
