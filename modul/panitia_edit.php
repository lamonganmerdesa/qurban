    <?php
	    $edit = mysqli_query($koneksi, "SELECT * FROM panitia WHERE id='$_GET[id]'");
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Update Data Panitia</li>
        </ol>
    </section>
    <section class="content">
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">UPDATE DATA PANITIA</h3>
			</div>
			<div class="box-body">
                <form method='POST' class="form-horizontal" action='modul/proses_panitia.php?act=update' enctype='multipart/form-data'>
                    <div class="box-body">
